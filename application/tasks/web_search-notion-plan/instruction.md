# Search and compare Notion workspace plans from DuckDuckGo
...
Start by formulating a search query on DuckDuckGo (e.g. searching for Notion pricing and plans), navigate to Notion's pricing page from the search results, compare the standard workspace plans, and select the **one plan you would most realistically choose**.
