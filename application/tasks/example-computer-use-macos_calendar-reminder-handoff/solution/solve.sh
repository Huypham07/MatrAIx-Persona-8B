...
# Oracle = artifact-contract smoke only (no LLM, no macOS UI).
# Proves output mounts + verifier accept handoff.txt / plan.json.
# For desktop UI harness smoke, run one persona-computer-1 trial.
